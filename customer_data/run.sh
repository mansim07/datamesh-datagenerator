...
cust_gcs_file="customers_data/date=2020-10-10/customer.csv"
cc_cust_gcs_file="cc_customers_data/date=2020-10-10/cc_customer.csv"
seed=1


python3 /Users/maharanam/OpenSourceCode/datamesh-datagenerator/customer_data/create_customers_cc_merchant.py 1000 ${seed} ../profiles/main_config.json ${local_data_path}/customer.csv ${local_data_path}/cc_customer.csv ${local_data_path}/cc_merchant_info_for_trans.csv ${cust_project} ${cust_bucket} ${cust_gcs_file} ${cc_cust_gcs_file}
